              ...
              properties:
                ...
                input:
                  ...
                  properties:
                    ...
                    voice:
                      description: >-
                        用于语音生成的语音。可为预设名称（如 Rachel、Adam）或 voice_id。可在浏览器中打开
                        `https://static.aiquickdraw.com/elevenlabs/voice/<voice_id>.mp3`
                        试听（将 <voice_id> 替换为实际语音
                        ID）。例如：`https://static.aiquickdraw.com/elevenlabs/voice/BIvP0GN1cAtSRTxNHnWS.mp3`
                        ...
                        **可用语音列表：**
                        ...
                        - `BIvP0GN1cAtSRTxNHnWS` - Ellen - 严肃、直接、自信

                        - `aMSt68OGf4xUZAnLpTU8` - Juniper - 沉稳、专业

                        - `RILOU7YmBhvwJGDGjNmP` - Jane - 专业有声书朗读者

                        - `EkK5I93UQWFDigLMpZcX` - James - 沙哑、引人入胜、大胆

                        - `Z3R5wn05IrDiVCyEkUrK` - Arabella - 神秘、富有情感

                        - `tnSpp4vdxKPjI9w0GnoV` - Hope - 积极向上、清晰

                        - `NNl6r8mD7vthiJatiJt1` - Bradford - 富有表现力、口齿清晰

                        - `YOq2y2Up4RgXP2HyXjE5` - Xavier - 霸气、金属感播音员

                        - `Bj9UqZbhQsanLzgalpEG` - Austin - 低沉、沙哑、真实

                        - `c6SfcYrb2t09NHXiT80T` - Jarnathan - 自信、多变

                        - `B8gJV1IhpuegLxdpXFOE` - Kuon - 开朗、清晰、稳定

                        - `exsUS4vynmxd379XN4yO` - Blondie - 对话式

                        - `BpjGufoPiobT79j2vtj4` - Priyanka - 平静、中性、放松
                        ...
                        - `DGTOOUoGpoP6UZ9uSWfA` - Célian - 纪录片旁白
                        ...
                        - `iP95p4xoKVk53GoZ742B` - Chris - 迷人、接地气

                        - `SOYHLrjzK2X1ezoPC6cr` - Harry - 凶猛的战士

                        - `N2lVS1w4EtoT3dr4eOWO` - Callum - 沙哑的骗子

                        - `FGY2WhTYpPnrIDTdsKH5` - Laura - 热情、古怪的态度

                        - `cgSgspJ2msm6clMCkdW9` - Jessica - 俏皮、明亮、温暖
                        ...
                        - `pNInz6obpgDQGcFmaJgB` - Adam - 主导、坚定
                        ...
                        - `ZF6FPAbjXT4488VcRRnw` - Amelia - 热情、富有表现力

                        - `8JVbfL6oEdmuxKn5DK2C` - Johnny Kid - 严肃、平静的旁白

                        - `iCrDUkL56s3C8sCRl7wb` - Hope - 诗意、浪漫、迷人

                        - `1hlpeD1ydbI2ow0Tt3EW` - Olivia - 流畅、温暖、引人入胜
                        ...
                        - `st7NwhTPEzqo2riw7qWC` - Blondie - 电台主持人
                        ...
                        - `Qggl4b0xRMiqOwhPtVWT` - Clara - 放松、平静、舒缓

                        - `zA6D7RyKdc2EClouEMkP` - AImee - 宁静ASMR与冥想
