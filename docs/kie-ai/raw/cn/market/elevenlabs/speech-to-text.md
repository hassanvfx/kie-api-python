...
paths:
  /api/v1/jobs/createTask:
    post:
              ...
              properties:
                model:
                  ...
                  description: |-
                    ...
                    - 此端点必须使用 `elevenlabs/speech-to-text`
                  examples:
                    - elevenlabs/speech-to-text
                callBackUrl:
                  type: string
                ...
                input:
                  ...
                  properties:
                    audio_url:
                      description: >-
                        要转录的音频文件 URL（上传后的文件 URL，不是文件内容；接受的类型：audio/mpeg,
                        audio/wav, audio/x-wav, audio/aac, audio/mp3,
                        audio/ogg；最大文件大小：200.0MB）
                      type: string
                      examples:
                        - >-
                          https://file.aiquickdraw.com/custom-page/akr/section-images/1757157053357tn37vxc8.mp3
                    language_code:
                      description: 音频的语言代码（最大长度：500 个字符）
                      type: string
                      maxLength: 500
                      examples:
                        - ''
                    tag_audio_events:
                      description: 标记音频事件，如笑声、掌声等（布尔值：true/false）
                      type: boolean
                      examples:
                        - true
                    diarize:
                      description: 是否标注说话人（布尔值：true/false）
                      type: boolean
                      examples:
                        - true
                  required:
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-28506701-run
components:
  schemas:
    ApiResponse:
      type: object
