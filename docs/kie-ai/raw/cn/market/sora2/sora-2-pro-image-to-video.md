  ...
  /api/v1/jobs/createTask:
    post:
      ...
      description: >-
        ...
        `character_id_list` 参数是可选的字符串数组（最多 5 个），允许您将多个角色动画整合到专业图生视频生成中。
              ...
              properties:
                model:
                  ...
                  description: |-
                    ...
                    - 该端点必须使用 `sora-2-pro-image-to-video` 模型
                  examples:
                    - sora-2-pro-image-to-video
                callBackUrl:
                  type: string
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-28506684-run
components:
  schemas:
    ApiResponse:
      type: object
