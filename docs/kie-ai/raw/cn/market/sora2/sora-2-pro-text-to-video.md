  ...
  /api/v1/jobs/createTask:
    post:
      ...
      description: >-
        ...
        `character_id_list` 参数是可选的字符串数组（最多 5 个），允许您将多个角色动画整合到专业文生视频生成中。
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-28506685-run
components:
  schemas:
    ApiResponse:
      type: object
