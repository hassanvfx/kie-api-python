  ...
  /api/v1/jobs/createTask:
    post:
      ...
      description: >-
        ...
        `character_id_list` 参数是可选的字符串数组（最多 5 个），允许您将多个角色动画整合到图生视频生成中。
        ...
        content:
          application/json:
              ...
              properties:
                model:
                  ...
                  description: |-
                    ...
                    - 该端点必须使用 `sora-2-image-to-video` 模型
                  examples:
                    - sora-2-image-to-video
                callBackUrl:
                  type: string
                ...
                input:
                  ...
                  properties:
                    prompt:
                      ...
                      examples:
                        - >-
                          一位黏土动画风格的指挥家饱含激情地指挥着黏土动画管弦乐队，整个乐团齐声欢快地合唱：“Sora 2 现已在
                          Kie AI 上线。”
                    image_urls:
                      description: >-
                        作为视频首帧的图像 URL。必须可公开访问（为上传后的文件
            ...
            example:
              ...
              input:
                prompt: >-
                  一位黏土动画风格的指挥家饱含激情地指挥着黏土动画管弦乐队，整个乐团齐声欢快地合唱：“Sora 2 现已在 Kie AI
                  上线。”
                image_urls:
                  - >-
                    https://file.aiquickdraw.com/custom-page/akr/section-images/17594315607644506ltpf.jpg
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-28506682-run
components:
  schemas:
    ApiResponse:
      type: object
