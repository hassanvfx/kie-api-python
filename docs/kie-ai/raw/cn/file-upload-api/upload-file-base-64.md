...
paths:
  /api/file-base64-upload:
    post:
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-28506751-run
components:
  schemas:
    Base64UploadRequest:
      type: object
      properties:
        base64Data:
          type: string
          description: Base64 编码的文件数据。支持纯 Base64 字符串或 data URL 格式
          examples:
