...
<CardGroup cols={3}>
  <Card title="Base64 上传" icon="lucide-code" href="/cn/file-upload-api/upload-file-base-64">
    Base64 编码文件上传，适合小文件
  </Card>

  <Card title="文件流上传" icon="lucide-upload" href="/cn/file-upload-api/upload-file-stream">
    高效的二进制文件流上传，适合大文件
  </Card>

  <Card title="URL 文件上传" icon="lucide-link" href="/cn/file-upload-api/upload-file-url">
    从远程 URL 自动下载并上传文件
  </Card>
</CardGroup>
...
<Tabs>
  <TabItem value="url-upload" label="URL 文件上传">
    适用于从远程服务器下载并上传文件：
  ...
  <TabItem value="stream-upload" label="文件流上传">
    适用于直接上传本地文件，特别是大文件：
  ...
  <TabItem value="base64-upload" label="Base64 上传">
    适用于 Base64 编码的文件数据：
...
<CardGroup cols={3}>
  <Card title="URL 文件上传" icon="lucide-link">
    **最适合**：文件迁移、批量处理
  ...
  <Card title="文件流上传" icon="lucide-upload">
    **最适合**：大文件、本地文件
  ...
  <Card title="Base64 上传" icon="lucide-code">
    **最适合**：小文件、API集成
...
准备开始上传文件了吗？[获取您的API密钥](https://kie.ai/api-key)，立即开始使用文件上传服务！
